...
publishing {
    ...
    publications.create<MavenPublication>("WLDTRelease") {
        ...
        pom {
            name = "MQTT Digital Adapter"
            url = "https://wldt.github.io/"
            description = project.description;
            licenses {
                license {
                    name = "Apache-2.0 license"
                    url = "https://raw.githubusercontent.com/wldt/mqtt-digital-adapter-java/main/LICENSE"
                }
            }
            ...
            scm {
                connection = "scm:git:https://github.com/wldt/mqtt-digital-adapter-java"
                url = "https://github.com/wldt/mqtt-digital-adapter-java"
            }
        }
    }
}
